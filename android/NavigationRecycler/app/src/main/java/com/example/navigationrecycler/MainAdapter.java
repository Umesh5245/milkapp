...
public class MainAdapter extends RecyclerView.Adapter<MainAdapter.MyAdapter> {
    ...
    public MainAdapter(ArrayList<SideNavClass> arrayList, Context context,DrawerLayout drawerLayout,FragmentManager fragmentManager) {
                ...
                public void onClick(View view) {
                    switch (position)
                    {
                        ...
                        case 2:
                            ...
                            break;
                        case 3:
                            Intent intent3 = new Intent(context,CouponsActivity.class);
