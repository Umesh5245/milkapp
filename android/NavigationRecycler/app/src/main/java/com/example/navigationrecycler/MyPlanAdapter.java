...
public class MyPlanAdapter extends RecyclerView.Adapter<MyPlanAdapter.MainAdapter>{


    Context context;
    ArrayList<MyPlanClass> arrayList;

    public MyPlanAdapter(Context context, ArrayList<MyPlanClass> arrayList) {
    ...
    public MainAdapter onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View view = LayoutInflater.from(context).inflate(R.layout.my_plan, parent,false);
